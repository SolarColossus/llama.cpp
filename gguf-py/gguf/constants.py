...
GGML_QUANT_SIZES: dict[GGMLQuantizationType, tuple[int, int]] = {
    ...
    GGMLQuantizationType.IQ2_K: (
        256,
        2 + 2 + QK_K // 32 + QK_K // 4,
    ),  # d(2) + extra(2) + scales[8] + qs[64] = 76
    GGMLQuantizationType.IQ3_KS: (256, 102),
    GGMLQuantizationType.IQ3_K: (
        256,
        2 + 2 + 2 + QK_K // 32 + QK_K // 4 + QK_K // 8,
    ),  # d(2) + extra(2) + scales_h(2) + scales_l[8] + qs[64] + qh[32] = 110
    GGMLQuantizationType.IQ4_K: (
        256,
        2 + 2 + QK_K // 64 + QK_K // 32 + QK_K // 2,
    ),  # d(2) + extra(2) + scales_h[4] + scales_l[8] + qs[128] = 144
    GGMLQuantizationType.IQ5_K: (
        256,
        2 + 2 + QK_K // 64 + QK_K // 32 + QK_K // 2 + QK_K // 8,
    ),  # d(2) + extra(2) + scales_h[4] + scales_l[8] + qs[128] + qh[32] = 176
    GGMLQuantizationType.IQ6_K: (
        256,
        2 + 2 + QK_K // 16 + QK_K // 2 + QK_K // 4,
    ),  # d(2) + extra(2) + scales[16] + qs[128] + qh[64] = 212
}
